...
public class PostFormRequest extends BaseRequest {
    ...
    public PostFormRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, int requestId, int invokeType, BaseCache cache, boolean hasResponseCode, List<PostFormBuilder.FileInput> files, String content) {
