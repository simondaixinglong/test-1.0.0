...
public class RateView extends View implements Runnable {
...
//        canvas.rotate(-90);
    ...
    private void drawText(Canvas canvas, int rate1, int rate2) {
        ...
        canvas.drawText(rate1 + "", width / 2 - bigWidth - 60, height / 2, rate1Paint);
        canvas.drawText("%", width / 2 - littleWidth - 20, height / 2, ratePaint1);
        canvas.drawText("浮动收益", width / 2 - tipWidth - 20, height / 2 + 20 + rect.height(), rate1TipPaint);

        canvas.drawText(rate2 + "", width / 2 + 40, height / 2, rate2Paint);
        canvas.drawText("%", width / 2 + bigWidth + 45, height / 2, ratePaint2);
        canvas.drawText("固定收益", width / 2 + 20, height / 2 + 20 + rect.height(), rate2TipPaint);
    }
