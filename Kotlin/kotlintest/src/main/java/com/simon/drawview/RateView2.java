...
public class RateView2 extends View implements Runnable {
    ...
    public RateView2(Context context) {
        this(context, null);
    }

    public RateView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RateView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        circleRadius = (height - 100) / 2;
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        drawText(canvas, rate1, rate2);

//        canvas.rotate(-90);
        //画比例弧
        drawArc1(canvas, arc2);
